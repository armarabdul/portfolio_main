...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    doiUrl: "https://doi.org/10.1109/COSMIC67569.2025.11380866",
    externalUrl: "https://ieeexplore.ieee.org/document/11380866",
  },
  {
    ...
    featured: true,
    conference:
      "2026 10th International Conference on Mechatronics Engineering (ICOM)",
    venue:
      "2026 10th International Conference on Mechatronics Engineering (ICOM)",
    authorRole: "Fifth Author",
    myContribution:
      "Contributed to the implementation, research, and technical documentation of the project. Built the federated learning implementation from scratch and contributed to the research methodology, system analysis, implementation, testing, results discussion, and documentation.",
    abstract:
      "The rapid digitization of medical records has opened significant opportunities for applying Artificial Intelligence in healthcare, particularly in diagnostic classification. However, centralized machine learning approaches require sensitive patient data to be aggregated into centralized repositories, creating substantial privacy and security risks. This research proposes a privacy-preserving medical data classification framework based on Federated Learning, enabling multiple hospital clients to collaboratively train a machine learning model without sharing their raw patient data. The system uses the Breast Cancer Wisconsin dataset for binary classification and simulates multiple hospital nodes, where each client performs local training using TensorFlow/Keras and shares only updated model weights with a central server through the Flower framework. The server aggregates the local weights using the Federated Averaging (FedAvg) algorithm to construct a global model. The results demonstrate that the federated approach can achieve high classification accuracy while preserving the confidentiality of localized medical data.",
    keywords: [
      "Federated Learning",
    ...
    authorDetails: [
      {
        ...
        institution: "Bearys Institute of Technlogy",
        city: "Mangalore",
        country: "India",
        email: "kshaheen0207@gmail.com",
      },
      {
        name: "Nubila Jaleel",
        department: "Computer Science and Engineering",
        ...
        city: "Mangalore",
        country: "India",
        email: "nubilajaleel@gmail.com",
      },
      {
        name: "Mohammed Hadi Habaebi",
        department: "Computer Science and Engineering",
        institution: "iium",
        country: "Malaysia",
        email: "Prof.habaebi@iium.edu.my",
      },
      {
        name: "Mohammed Sinan Marikattay",
        department: "Computer Science and Engineering",
        institution: "Bearys Institute of Technlogy",
        city: "Mangalore",
        country: "India",
        email: "meetsinan@gmail.com",
      },
      {
    ...
    experimentalResults: [
      { label: "Global Accuracy", value: "97.1%" },
